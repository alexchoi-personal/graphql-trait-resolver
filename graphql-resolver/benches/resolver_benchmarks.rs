...
const COMPLEX_SDL: &str = r#"
    ...
    type Post {
        ...
        content: String
        authorId: ID!
        author: User @resolver(name: "getUserById") @batchKey(field: "authorId")
        comments: [Comment!]! @resolver(name: "getCommentsByPost") @batchKey(field: "id")
    }
...
const DEEPLY_NESTED_SDL: &str = r#"
    ...
    type Organization {
        id: ID!
        name: String!
        departments: [Department!]! @resolver(name: "getDepartments") @batchKey(field: "id")
    }

    type Department {
        id: ID!
        name: String!
        teams: [Team!]! @resolver(name: "getTeams") @batchKey(field: "id")
    }

    type Team {
        id: ID!
        name: String!
        members: [User!]! @resolver(name: "getMembers") @batchKey(field: "id")
    }

    type User {
        id: ID!
        name: String!
        tasks: [Task!]! @resolver(name: "getTasks") @batchKey(field: "id")
    }
...
const ECOMMERCE_SDL: &str = r#"
    ...
    type Product {
        ...
        inventory: Int!
        categoryId: ID!
        category: Category! @resolver(name: "getCategoryById") @batchKey(field: "categoryId")
        reviews: [Review!]! @resolver(name: "getReviewsByProduct") @batchKey(field: "id")
        relatedProducts: [Product!]! @resolver(name: "getRelatedProducts") @batchKey(field: "id")
    }
    ...
    type Category {
        ...
        slug: String!
        parentId: ID
        parent: Category @resolver(name: "getCategoryById") @batchKey(field: "parentId")
        products: [Product!]! @resolver(name: "getProductsByCategory") @batchKey(field: "id")
    }
    ...
    type Customer {
        ...
        phone: String
        addresses: [Address!]!
        orders: [Order!]! @resolver(name: "getOrdersByCustomer") @batchKey(field: "id")
        wishlist: [Product!]! @resolver(name: "getWishlistProducts") @batchKey(field: "id")
    }
    ...
    type Order {
        ...
        status: OrderStatus!
        customerId: ID!
        customer: Customer! @resolver(name: "getCustomerById") @batchKey(field: "customerId")
        items: [OrderItem!]!
        subtotal: Float!
        tax: Float!
        shipping: Float!
    ...
    type OrderItem {
        id: ID!
        productId: ID!
        product: Product! @resolver(name: "getProductById") @batchKey(field: "productId")
        quantity: Int!
        unitPrice: Float!
        total: Float!
    }
...
const SOCIAL_MEDIA_SDL: &str = r#"
    ...
    type User {
        ...
        followingCount: Int!
        postCount: Int!
        followers: [User!]! @resolver(name: "getFollowers") @batchKey(field: "id")
        following: [User!]! @resolver(name: "getFollowing") @batchKey(field: "id")
        posts: [Post!]! @resolver(name: "getPostsByUser") @batchKey(field: "id")
        likedPosts: [Post!]! @resolver(name: "getLikedPosts") @batchKey(field: "id")
        notifications: [Notification!]! @resolver(name: "getNotifications") @batchKey(field: "id")
        createdAt: String!
    }
    ...
    type Post {
        ...
        commentCount: Int!
        repostCount: Int!
        likes: [Like!]! @resolver(name: "getLikesByPost") @batchKey(field: "id")
        comments: [Comment!]! @resolver(name: "getCommentsByPost") @batchKey(field: "id")
        hashtags: [Hashtag!]!
        mentions: [User!]! @resolver(name: "getMentionedUsers") @batchKey(field: "id")
        repostedFrom: Post @resolver(name: "getOriginalPost") @batchKey(field: "id")
        createdAt: String!
    }
    ...
    type Comment {
        ...
        author: User! @resolver(name: "getUserById") @batchKey(field: "authorId")
        likeCount: Int!
        replies: [Comment!]! @resolver(name: "getReplies") @batchKey(field: "id")
        createdAt: String!
    }
    ...
    type Like {
        id: ID!
        userId: ID!
        user: User! @resolver(name: "getUserById") @batchKey(field: "userId")
        createdAt: String!
    }
    ...
    type Hashtag {
        ...
        name: String!
        postCount: Int!
        posts: [Post!]! @resolver(name: "getPostsByHashtag") @batchKey(field: "id")
    }
    ...
    type Notification {
        ...
        actorId: ID!
        actor: User! @resolver(name: "getUserById") @batchKey(field: "actorId")
        postId: ID
        post: Post @resolver(name: "getPostById") @batchKey(field: "postId")
        read: Boolean!
        createdAt: String!
    }
...
const GITHUB_LIKE_SDL: &str = r#"
    ...
    type Repository {
        ...
        description: String
        ownerId: ID!
        owner: RepositoryOwner! @resolver(name: "getOwner") @batchKey(field: "ownerId")
        visibility: Visibility!
        defaultBranch: String!
        starCount: Int!
        forkCount: Int!
        watcherCount: Int!
        issues(state: IssueState): [Issue!]! @resolver(name: "getIssuesByRepo") @batchKey(field: "id")
        pullRequests(state: PRState): [PullRequest!]! @resolver(name: "getPRsByRepo") @batchKey(field: "id")
        branches: [Branch!]! @resolver(name: "getBranches") @batchKey(field: "id")
        releases: [Release!]! @resolver(name: "getReleases") @batchKey(field: "id")
        contributors: [User!]! @resolver(name: "getContributors") @batchKey(field: "id")
        languages: [Language!]!
        topics: [String!]!
        license: String
        createdAt: String!
    ...
    type User {
        ...
        company: String
        location: String
        repositories: [Repository!]! @resolver(name: "getReposByUser") @batchKey(field: "id")
        starredRepositories: [Repository!]! @resolver(name: "getStarredRepos") @batchKey(field: "id")
        followers: [User!]! @resolver(name: "getFollowers") @batchKey(field: "id")
        following: [User!]! @resolver(name: "getFollowing") @batchKey(field: "id")
        organizations: [Organization!]! @resolver(name: "getOrganizations") @batchKey(field: "id")
    ...
    type Organization {
        ...
        avatarUrl: String!
        websiteUrl: String
        repositories: [Repository!]! @resolver(name: "getReposByOrg") @batchKey(field: "id")
        members: [User!]! @resolver(name: "getOrgMembers") @batchKey(field: "id")
        teams: [Team!]! @resolver(name: "getOrgTeams") @batchKey(field: "id")
    }
    ...
    type Team {
        ...
        slug: String!
        description: String
        members: [User!]! @resolver(name: "getTeamMembers") @batchKey(field: "id")
        repositories: [Repository!]! @resolver(name: "getTeamRepos") @batchKey(field: "id")
    }
    ...
    type Issue {
        ...
        authorId: ID!
        author: User! @resolver(name: "getUserById") @batchKey(field: "authorId")
        assignees: [User!]! @resolver(name: "getAssignees") @batchKey(field: "id")
        labels: [Label!]!
        comments: [IssueComment!]! @resolver(name: "getIssueComments") @batchKey(field: "id")
        milestone: Milestone
        createdAt: String!
        updatedAt: String!
        closedAt: String
    ...
    type PullRequest {
        ...
        mergeable: Boolean
        merged: Boolean!
        reviewers: [User!]! @resolver(name: "getReviewers") @batchKey(field: "id")
        reviews: [Review!]! @resolver(name: "getPRReviews") @batchKey(field: "id")
        commits: [Commit!]! @resolver(name: "getPRCommits") @batchKey(field: "id")
        comments: [IssueComment!]! @resolver(name: "getPRComments") @batchKey(field: "id")
        labels: [Label!]!
        createdAt: String!
        updatedAt: String!
        mergedAt: String
    ...
    type Branch {
        name: String!
        commitId: ID!
        commit: Commit! @resolver(name: "getCommitById") @batchKey(field: "commitId")
        protected: Boolean!
    }
...
impl Resolver for MockResolver {
    ...
    fn resolve<'a>(
        ...
        Box::pin(async move { Ok(Value::Object(Default::default())) })
    }
}
    ...
    fn load_erased<'a>(
        ...
        Box::pin(async move {
            let results: Vec<(serde_json::Value, serde_json::Value)> = keys
                .into_iter()
                .map(|post_id| {
                    let comments: Vec<serde_json::Value> = (1..=2)
                        .map(|i| {
                            serde_json::json!({
...
fn bench_sdl_parsing(c: &mut Criterion) {
    ...
    for (name, sdl) in schemas {
        ...
        group.bench_with_input(BenchmarkId::new(*name, sdl.len()), sdl, |b, sdl| {
            b.iter(|| {
...
fn bench_n1_detection(c: &mut Criterion) {
    ...
    group.bench_function("simple_schema_validation", |b| {
        b.iter(|| {
            let server = GraphQLServer::builder().sdl(black_box(SIMPLE_SDL)).build();
            black_box(server)
        });
    });
...
fn bench_query_execution(c: &mut Criterion) {
    ...
    let server = GraphQLServer::builder().sdl(SIMPLE_SDL).build().unwrap();
...
fn bench_schema_size_comparison(c: &mut Criterion) {
    ...
    for (name, sdl) in schemas {
        ...
        group.bench_with_input(BenchmarkId::new("build_time", name), sdl, |b, sdl| {
            b.iter(|| {
                let server = GraphQLServer::builder()
                    .sdl(black_box(sdl))
                    .skip_n1_validation()
