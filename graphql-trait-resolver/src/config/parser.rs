...
use crate::directive::{
    find_directive, parse_batch_key_directive, parse_call_directive, parse_trait_directive,
};
...
mod tests {
    ...
    fn test_parse_error_display() {
        ...
        let err2 = ParseError::InvalidTypeDefinition("bad type".to_string());
        assert_eq!(err2.to_string(), "Invalid type definition: bad type");
    }
